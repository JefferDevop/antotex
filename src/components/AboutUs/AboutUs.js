  ...
  return (
    <div className={styles.container}>
      <div className={styles.about}>
        <h1>Nosotros</h1>
        <p>
          Bienvenidos a ANTOTEX DISTRIBUIDORA. Nos dedicamos a ofrecer prendas
          de vestir y accesorios, para todas las edades. Nuestra pasión por la moda se
      ...
      <div className={styles.mision}>
        <h5>Misión</h5>
        <p>
          Nuestra misión en ANTONTEX es ofrecer a nuestros clientes una
          ...
          de manera ética y respetuosa con el medio ambiente. En ANTOTEX, nos
      ...
      <div className={styles.vision}>
        <h5>Visión</h5>
        <p>
          En ANTOTEX, nuestra visión es convertirnos en la tienda líder en
          ...
          En resumen, nuestra visión en ANTOTEX es liderar la industria de la
